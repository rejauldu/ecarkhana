...
<html lang="en">
	...
	<body>
		<div style='width:92%; max-width:800px; margin:0 auto; border:1px solid #dedede; padding:0 3% 5% 3%; display:block; overflow:hidden; font-family:myriad-pro;'>
			...
			<div style="width:100%;">
				<h3 style="text-transform: uppercase;">Order Received</h3>
			</div>
			<div style="width:100%;text-align:justify">
				<p>Dear {{ $order->customer->name ?? 'Customer'}},</p>
				<p>Thank you for reaching us. We have received your order. Your order details are indicated below.</p>
			</div>
			<div style="width:100%">
			...
			<div style="width:100%; color:#a94442; background-color: #f2dede; padding: 15px; border:1px solid #ebccd1; border-radius: 4px">We have created an account for you in {{ url('/') }}. You can login using your email address and the password: <strong>{{ $password ?? '' }}</strong></div>
			<div style="width:100%; height:30px;"></div>
			<hr style="color:#555; border-top:1px dotted #555;">
			<div style="width:100%; height:30px;"></div>
			@endif
			<div style="width:100%">
				<p>For any further questions or concerns, please contact at {{ env('PHONE_CONTACT_US') }}, customer service.</p>
