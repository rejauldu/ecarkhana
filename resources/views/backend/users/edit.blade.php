                        ...
                        <div class="row py-2">
                            ...
                            <div class="col-12 col-md-9">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#other">Others</a></li>
                                    @endif
                                </ul>
                                <div class="tab-content mt-3">
                                    ...
                                    <div class="tab-pane" id="other">
                                        ...
                                        <form class="ajax-upload d-none" action="{{ route('users.update', $profile->id) }}" method="post">
                                            @csrf
                                            @method('PUT')
