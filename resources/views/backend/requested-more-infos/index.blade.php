			...
			<div class="col-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h3 class="box-title"><i class="fa fa-bell mr-1"></i> {{ __('All Infos') }}</h3>
						...
						<table id="dataTables" class="display nowrap" cellspacing="0" width="100%">
							...
							<tbody>
								...
								<tr>
									<td>{{ $info->id }}</td>
									<td>{{ $info->email }}</td>
									<td>{{ $info->created_at->format('jS M Y') }}</td>
									<td><a href="{{ route('requested-more-infos.show', $info->id) }}" class="text-primary fa fa-eye"></a></td>
								</tr>
								@endforeach
							</tbody>
							<tfoot>
