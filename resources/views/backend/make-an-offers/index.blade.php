			...
			<div class="col-12">
				<div class="box box-offer">
					<div class="box-header with-border">
						<h3 class="box-title"><i class="fa fa-bell mr-1"></i> {{ __('All Offers') }}</h3>
						...
						<table id="dataTables" class="display nowrap" cellspacing="0" width="100%">
							...
							<tbody>
								...
								<tr>
									<td>{{ $offer->id }}</td>
									<td>{{ $offer->email }}</td>
									<td>{{ $offer->created_at->format('jS M Y') }}</td>
									<td><a href="{{ route('make-an-offers.show', $offer->id) }}" class="text-primary fa fa-eye"></a></td>
								</tr>
								@endforeach
							</tbody>
							<tfoot>
