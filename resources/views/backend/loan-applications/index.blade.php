...
<div class="content-wrapper">
	<div class="container-fluid">
		<section class="content-header">
			<h3>Loan Application <small>all</small></h3>
			<ol class="breadcrumb">
			...
			<div class="col-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h3 class="box-title"><i class="fa fa-bell mr-1"></i> {{ __('All Loan Applications') }}</h3>
						...
						<table id="dataTables" class="display nowrap" cellspacing="0" width="100%">
							...
							<tbody>
								...
								<tr>
									...
									<td>{{ $loan_application->name }}</td>
									<td>{{ $loan_application->email }}</td>
									<td>{{ $loan_application->amount }}</td>
									<td><a href="{{ route('loan-applications.show', $loan_application->id) }}" class="text-primary fa fa-eye"></a></td>
								</tr>
								@endforeach
							</tbody>
							<tfoot>
