...
@section('title')
{{ __('All Starting Systems') }}
@endsection
@section('content')
<div class="content-wrapper">
	<div class="container-fluid">
		<section class="content-header">
			<h3>Starting System <small>all</small></h3>
			<ol class="breadcrumb">
				<li><a href="{{ route('dashboard') }}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
				<li class="active">Starting Systems</li>
			</ol>
		</section>
			...
			<div class="col-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<a href="{{ route('starting-systems.create') }}"><i class="fa fa-credit-card mr-1"></i> {{ __('Add new Starting Systems') }}</a>
					...
					<div class="box-body">
						<table id="dataTables" class="display nowrap" cellspacing="0" width="100%">
							...
							<tbody>
								...
								<tr>
									<td>{{ $starting_system->id }}</td>
									<td>{{ $starting_system->category->name ?? ''}}</td>
