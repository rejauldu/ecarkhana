                            ...
                            <div class="col-12"><!--left col-->
                                <form action="@if(isset($coverage)) {{ route('coverages.update', $coverage->id) }} @else {{ route('coverages.store') }} @endif" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control editor-tools" rows="5" id="note">{!! $coverage->description ?? '' !!}</textarea>
                                        <div class="valid-feedback">Valid.</div>
                                        <div class="invalid-feedback">Please fill out this field.</div>
                                    </div>
                                    <div class="form-group">
                                        <label for="name">Rate</label>
                                        <input id="rate" type="number" class="form-control" name="rate" value="{{ $coverage->rate ?? '' }}" placeholder="Rate" title="Enter rate." />
                                    </div>
