...
@section('title')
{{ __('All Pros and Conss') }}
@endsection
@section('content')
<div class="content-wrapper">
	<div class="container-fluid">
		<section class="content-header">
			<h3>Pros and Cons <small>all</small></h3>
			<ol class="breadcrumb">
				<li><a href="{{ route('dashboard') }}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
				<li class="active">Pros and Conss</li>
			</ol>
		</section>
			...
			<div class="col-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<a href="{{ route('pros-conses.create') }}"><i class="fa fa-credit-card mr-1"></i> {{ __('Add new Pros and Conss') }}</a>
						...
						<table id="dataTables" class="display nowrap" cellspacing="0" width="100%">
							...
							<tbody>
								...
								<tr>
									...
									<td><a href="{{ route('pros-conses.destroy', $pros_cons->id) }}" onclick="event.preventDefault(); document.getElementById('delete-form').action = this.href; document.getElementById('delete-form').submit.click();" class="text-danger fa fa-trash"></button></td>
								</tr>
								@endforeach
							</tbody>
							<tfoot>
