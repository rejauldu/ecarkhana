...
@section('title')
{{ __('All Auction Grades') }}
@endsection
@section('content')
<div class="content-wrapper">
	<div class="container-fluid">
		<section class="content-header">
			<h3>Auction Grade <small>all</small></h3>
			<ol class="breadcrumb">
				<li><a href="{{ route('dashboard') }}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
				<li class="active">Auction Grades</li>
			</ol>
		</section>
			...
			<div class="col-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<a href="{{ route('auction-grades.create') }}"><i class="fa fa-credit-card mr-1"></i> {{ __('Add new Auction Grades') }}</a>
