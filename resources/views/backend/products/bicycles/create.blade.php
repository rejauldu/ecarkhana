											...
											<div class="row">
												<div class="col-12 col-md-6">
													...
													<div class="row">
														...
														<div class="col-6 form-group">
															<img id="image1-view" style="width:50px; height:50px" src="{{ asset('/assets/products/bicycles') }}/{{ $bicycle->image1 ?? 'not-found.jpg'}}" class="img-thumbnail" alt="Car">
														</div>
													</div>
													<div class="row">
														<div class="col-6 form-group">
														...
														<div class="col-6 form-group">
															<img id="image2-view" style="width:50px; height:50px" src="{{ asset('/assets/products/bicycles') }}/{{ $bicycle->image2 ?? 'not-found.jpg'}}" class="img-thumbnail" alt="Car">
														</div>
													</div>
													<div class="row">
														<div class="col-6 form-group">
														...
														<div class="col-6 form-group">
															<img id="image3-view" style="width:50px; height:50px" src="{{ asset('/assets/products/bicycles') }}/{{ $bicycle->image3 ?? 'not-found.jpg'}}" class="img-thumbnail" alt="Car">
														</div>
													</div>
													<div class="row">
														<div class="col-6 form-group">
														...
														<div class="col-6 form-group">
															<img id="image4-view" style="width:50px; height:50px" src="{{ asset('/assets/products/bicycles') }}/{{ $bicycle->image4 ?? 'not-found.jpg'}}" class="img-thumbnail" alt="Car">
														</div>
													</div>
													<div class="row">
														<div class="col-6 form-group">
														...
														<div class="col-6 form-group">
															<img id="image5-view" style="width:50px; height:50px" src="{{ asset('/assets/products/bicycles') }}/{{ $bicycle->image5 ?? 'not-found.jpg'}}" class="img-thumbnail" alt="Car">
														</div>
													</div>
													<div class="row">
														<div class="col-6 form-group">
														...
														<div class="col-6 form-group">
															<img id="image6-view" style="width:50px; height:50px" src="{{ asset('/assets/products/bicycles') }}/{{ $bicycle->image6 ?? 'not-found.jpg'}}" class="img-thumbnail" alt="Car">
														</div>
													</div>
													<div class="row">
														<div class="col-6 form-group">
														...
														<div class="col-6 form-group">
															<img id="image7-view" style="width:50px; height:50px" src="{{ asset('/assets/products/bicycles') }}/{{ $bicycle->image7 ?? 'not-found.jpg'}}" class="img-thumbnail" alt="Car">
														</div>
													</div>
													<div class="row">
														<div class="col-6 form-group">
														...
														<div class="col-6 form-group">
															<img id="image8-view" style="width:50px; height:50px" src="{{ asset('/assets/products/bicycles') }}/{{ $bicycle->image8 ?? 'not-found.jpg'}}" class="img-thumbnail" alt="Car">
														</div>
													</div>
													<div class="row">
														<div class="col-6 form-group">
														...
														<div class="col-6 form-group">
															<img id="image9-view" style="width:50px; height:50px" src="{{ asset('/assets/products/bicycles') }}/{{ $bicycle->image9 ?? 'not-found.jpg'}}" class="img-thumbnail" alt="Car">
														</div>
													</div>
													<div class="row">
														<div class="col-6 form-group">
														...
														<div class="col-6 form-group">
															<img id="image10-view" style="width:50px; height:50px" src="{{ asset('/assets/products/bicycles') }}/{{ $bicycle->image10 ?? 'not-found.jpg'}}" class="img-thumbnail" alt="Car">
														</div>
													</div>
												</div>
												<div class="col-12 col-md-6">
													...
													<div class="form-group">
														...
														<input id="pedial" type="text" class="form-control" name="pedial" value="{{ $bicycle->pedial ?? '' }}" placeholder="Enter Pedal" title="Enter Pedal" />
													</div>
													<div class="form-group">
