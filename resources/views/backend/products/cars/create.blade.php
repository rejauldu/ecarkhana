											...
											<div class="row">
												<div class="col-12 col-md-6">
													...
													<div class="row">
														...
														<div class="col-6 form-group">
															<img id="image1-view" style="width:50px; height:50px" src="{{ asset('/assets/products/cars') }}/{{ $car->image1 ?? 'not-found.jpg'}}" class="img-thumbnail" alt="Car">
														</div>
													</div>
													<div class="row">
														<div class="col-6 form-group">
														...
														<div class="col-6 form-group">
															<img id="image2-view" style="width:50px; height:50px" src="{{ asset('/assets/products/cars') }}/{{ $car->image2 ?? 'not-found.jpg'}}" class="img-thumbnail" alt="Car">
														</div>
													</div>
													<div class="row">
														<div class="col-6 form-group">
														...
														<div class="col-6 form-group">
															<img id="image3-view" style="width:50px; height:50px" src="{{ asset('/assets/products/cars') }}/{{ $car->image3 ?? 'not-found.jpg'}}" class="img-thumbnail" alt="Car">
														</div>
													</div>
													<div class="row">
														<div class="col-6 form-group">
														...
														<div class="col-6 form-group">
															<img id="image4-view" style="width:50px; height:50px" src="{{ asset('/assets/products/cars') }}/{{ $car->image4 ?? 'not-found.jpg'}}" class="img-thumbnail" alt="Car">
														</div>
													</div>
													<div class="row">
														<div class="col-6 form-group">
														...
														<div class="col-6 form-group">
															<img id="image5-view" style="width:50px; height:50px" src="{{ asset('/assets/products/cars') }}/{{ $car->image5 ?? 'not-found.jpg'}}" class="img-thumbnail" alt="Car">
														</div>
													</div>
													<div class="row">
														<div class="col-6 form-group">
														...
														<div class="col-6 form-group">
															<img id="image6-view" style="width:50px; height:50px" src="{{ asset('/assets/products/cars') }}/{{ $car->image6 ?? 'not-found.jpg'}}" class="img-thumbnail" alt="Car">
														</div>
													</div>
													<div class="row">
														<div class="col-6 form-group">
														...
														<div class="col-6 form-group">
															<img id="image7-view" style="width:50px; height:50px" src="{{ asset('/assets/products/cars') }}/{{ $car->image7 ?? 'not-found.jpg'}}" class="img-thumbnail" alt="Car">
														</div>
													</div>
													<div class="row">
														<div class="col-6 form-group">
														...
														<div class="col-6 form-group">
															<img id="image8-view" style="width:50px; height:50px" src="{{ asset('/assets/products/cars') }}/{{ $car->image8 ?? 'not-found.jpg'}}" class="img-thumbnail" alt="Car">
														</div>
													</div>
													<div class="row">
														<div class="col-6 form-group">
														...
														<div class="col-6 form-group">
															<img id="image9-view" style="width:50px; height:50px" src="{{ asset('/assets/products/cars') }}/{{ $car->image9 ?? 'not-found.jpg'}}" class="img-thumbnail" alt="Car">
														</div>
													</div>
													<div class="row">
														<div class="col-6 form-group">
														...
														<div class="col-6 form-group">
															<img id="image10-view" style="width:50px; height:50px" src="{{ asset('/assets/products/cars') }}/{{ $car->image10 ?? 'not-found.jpg'}}" class="img-thumbnail" alt="Car">
														</div>
													</div>
												</div>
												<div class="col-12 col-md-6">
