        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="add_compare">
                    <div class="checkbox">
                        <input type="checkbox" class="compare-checkbox" id="product-{{ $product->id }}" product-id="{{ $product->id }}">
                        <label for="product-{{ $product->id }}">Add to Compare</label>
                    </div>
                </div>
                        ...
                        <div class="user-info-card">
                            ...
                            <div class="user-information">
                                ...
                                <div class="item-date">
                                    ...
                                    @if($product->supplier)
                                    <br>
                                    <a href="{{ route('cars.index') }}" class="link">More Ads</a>
                                    @endif
                                </div>
                    ...
                    <div class="item">
                        <div class="bg-white shadow-sm mx-2 zoom-parent overflow-hidden shadow-hover-10">
                            ...
                            <div class="text-dark clearfix px-3 py-1">
                                ...
                                <div class="separator"></div>
                                <div class="text-center form-16">BDT {{ $used_product->msrp }}</div>
