            ...
            <div class="col-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-credit-card mr-1"></i> {{ __('All Loan Infos') }}</h3>
                    ...
                    <div class="box-body">
                        <table id="dataTables" class="display nowrap" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                @foreach($loan_infos as $loan_info)
                                <tr>
                                    <td>{{ $loan_info->id }}</td>
                                    ...
                                    <td><a href="{{ route('loan-infos.show', $loan_info->id) }}" class="text-success fa fa-eye"></a></td>
                                </tr>
                                @endforeach
                            </tbody>
                            <tfoot>
