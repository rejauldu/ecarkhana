        ...
        <div class="container">
                                ...
                                <div class="modal fade" id="exampleModal3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form class="gray-form reset_css ajax-upload" id="mao_form" action="{{ route('make-an-offers.store') }}" method="post">
													@csrf
													<input type="hidden" name="product_id" value="{{ $product->id }}" />
                                                    <div class="form-group">
                                                        <label>Name*</label>
                                                        <input type="text" id="mao_name" name="name" id="validationCustom192" required="" class="form-control">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Email address*</label>
                                                        <input type="text" id="mao_email" name="email" id="validationCustom193" required="" class="form-control">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Phone*</label>
                                                        <input type="text" id="mao_phone" name="phone" id="validationCustom194" required="" class="form-control">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Offered Price*</label>
                                                        <input type="text" id="mao_price" name="price" id="validationCustom195" required="" class="form-control">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Financing Required*</label>
                                                        <div class="selected-box">
                                                            <select class="selectpicker" id="financing_required" id="validationCustom196" required="" name="mao_financing">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form class="gray-form reset_css" action="post" id="etf_form">
                                                    <div class="form-group">
                                                        <label>Name*</label>
                                                        <input name="name" type="text" id="etf_name" id="validationCustom182" required="" class="form-control">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Email address*</label>
                                                        <input type="text" class="form-control" id="etf_email" id="validationCustom183" required="" name="email">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Friends Email*</label>
                                                        <input type="Email" class="form-control" id="etf_fmail" id="validationCustom184" required="" name="fmail">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Message to friend</label>
                                                        <textarea class="form-control input-message" id="etf_fmessage" name="message" rows="4"></textarea>
                                                    </div>
                                                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="slider-slick">
                        <div class="slider slider-for detail-big-car-gallery">
                            <img class="img-fluid" src="{{ url('/') }}/assets/products/cars/{{ $product->car->image1 }}" alt="">
							<img class="img-fluid" src="{{ url('/') }}/assets/products/cars/{{ $product->car->image2 }}" alt="">
							<img class="img-fluid" src="{{ url('/') }}/assets/products/cars/{{ $product->car->image3 }}" alt="">
							<img class="img-fluid" src="{{ url('/') }}/assets/products/cars/{{ $product->car->image4 }}" alt="">
							<img class="img-fluid" src="{{ url('/') }}/assets/products/cars/{{ $product->car->image5 }}" alt="">
							<img class="img-fluid" src="{{ url('/') }}/assets/products/cars/{{ $product->car->image6 }}" alt="">
							<img class="img-fluid" src="{{ url('/') }}/assets/products/cars/{{ $product->car->image7 }}" alt="">
							<img class="img-fluid" src="{{ url('/') }}/assets/products/cars/{{ $product->car->image8 }}" alt="">
							<img class="img-fluid" src="{{ url('/') }}/assets/products/cars/{{ $product->car->image9 }}" alt="">
							<img class="img-fluid" src="{{ url('/') }}/assets/products/cars/{{ $product->car->image10 }}" alt="">
                        </div>
                ...
                <div class="col-md-4">
                    <div class="add_compare">
                        <div class="checkbox">
                            <input type="checkbox" class="compare-checkbox" class="compare-checkbox" value="" id="compare14">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div id="tabs">
                        <ul class="tabs">
                            <li data-tabs="tab1" class="active"> <span aria-hidden="true" class="icon-diamond"></span>Specification</li>
                        ...
                        <div id="tab1" class="tabcontent">
                            <ul class="smsaccordion">
                                <li>
                                    ...
                                    <ul class="smsinner" style="display: block;">
                                        ...
                                        <li class="">
                                            ...
                                            <div class="list-stat">{{ $product->car->displacement->name ?? '' }} cc</div>
                                        </li>
                                        <li class="">
                                        ...
                                        <li class="">
                                            ...
                                            <div class="list-stat">{{ $product->car->ground_clearance->name ?? '' }}</div>
                                        </li>
                                        <li class="">
                                ...
                                <li>
                                    <a class="smstoggle"> wheels tyre steering and brakes <i class="fa fa-chevron-down"></i></a>
                                    <ul class="smsinner">
                                        <li class="">
                                ...
                                <li>
                                    ...
                                    <ul class="smsinner">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="sixcol">
                                                    <p><i class="fa fa-american-sign-language-interpreting" aria-hidden="true"></i> Interior</p>
                                            ...
                                            <div class="col-md-6">
                                                <div class="sixcol last">
                                                    <p><i class="fa fa-assistive-listening-systems" aria-hidden="true"></i> Exterior</p>
                                                    <ul class="row tablist">
                            ...
                            <div class="details-form contact-2">
                                <form class="gray-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="validationCustom11" placeholder="Price" required="">
                                    </div>
                                    <div class="form-group">
                                        <label>Interest rate (%)*</label>
                                        <input type="text" class="form-control" placeholder="Rate" id="validationCustom12" required="">
                                    </div>
                                    <div class="form-group">
                                        <label>Period (Month)*</label>
                                        <input type="text" class="form-control" placeholder="Month" id="validationCustom13" required="">
                                    </div>
                                    <div class="form-group">
                                        <label>Down Payment *</label>
                                        <input type="text" class="form-control" placeholder="Payment" id="validationCustom14" required="">
                                    </div>
                                    <div class="form-group">
									...
									<div class="item">
										<div class="featured-car-list">
											...
											<div class="featured-car-content">
												<h6><a href="single-car-product/{{ $related_product->id }}">{{ $related_product->car->brand->name ?? ''}}</a></h6>
