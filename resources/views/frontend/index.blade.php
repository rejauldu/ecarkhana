                    ...
                    <div class="owl-carousel owl-theme" data-nav-arrow="true" data-items="3" data-md-items="3" data-sm-items="2" data-xs-items="1" data-space="20">
                        ...
                        <div class="item">
                            <div class="car-item text-center">
                                <div class="car-image">
                                    <img class="img-fluid" src="{{ url('/') }}/assets/products/cars/{{ $new_product->car->image1 }}" alt="">
                                ...
                                <div class="car-content">
                                    ...
                                    <a href="{{ url('/') }}/single-car-product/{{ $new_product->id }}">{{ $new_product->name }}</a>
                                    <div class="separator"></div>
                                    <div class="price">
                        ...
                        <div class="item">
                            <div class="featured-car-list">
                                <div class="featured-car-img">
                                    <a href=""><img src="assets/products/cars/{{ $used_product->car->image1 }}" class="img-responsive" alt="Image"></a>
                                ...
                                <div class="featured-car-content">
                                    <h6><a href="single-car-product/{{ $used_product->id }}">{{ $used_product->car->brand->name ?? ''}}</a></h6>
                ...
                <div class="col-md-12">
                    ...
                    <div class="owl-carousel owl-theme" data-nav-arrow="true" data-items="4" data-md-items="4" data-sm-items="2" data-xs-items="1" data-space="20">
                        ...
                        <div class="item">
                            <div class="car-item text-center">
                                <div class="car-image">
                                    <img class="img-fluid" src="assets/products/cars/{{ $popular_product->car->image1 }}" alt="">
                                    <div class="car-overlay-banner">
                                        <ul>
                                            <li>
                                                <div class="compare_item">
