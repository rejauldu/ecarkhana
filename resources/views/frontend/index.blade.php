...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-12">
                    <nav>
                        <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link active" id="nav-blog-tab" data-toggle="tab" href="#nav-blog"
                               role="tab" aria-controls="nav-blog" aria-selected="true">Blog</a>
                        </div>
                    </nav>
                    <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-blog" role="tabpanel"
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="float-left size-11">
                                                <img
                                                    src="{{ url('/') }}/assets/blogs/{{ $post->thumbnail ?? 'not-found.jpg' }}"
                                                    alt="" class="img-fluid">
                                            </div>
                                            <div class="hover_icon">
                                                <a href="{{ route('blogs.show', $post->id) }}" class="hvr_btn"><i
                                        ...
                                        <div class="col-6">
                                            <div class="blog_info">
                                                ...
                                                <div class="meta">
                                                    <p>{{ $post->user->name }}
                                                        <span>|</span> {{ $post->created_at->format('jS M Y') }}</p>
                                                </div>
                ...
                <div class="col-lg-8 col-12 text-center">
                    ...
                    <div class="owl-carousel owl-theme" data-nav-arrow="true" data-items="3" data-md-items="3"
                         data-sm-items="2" data-xs-items="1" data-space="0">
                            ...
                            <div class="item">
                                <div class="bg-white product-hover-effect shadow-sm mx-1">
                                    <div class="size-53">
                                        <div class="size-child overflow-hidden">
                                            <a href="{{ route('products.show', $new_product->id) }}"
                                               class="w-100 h-100 d-inline-block">
                                                <img class="position-center h-auto w-100"
                                                     src="{{ url('/') }}/assets/products/{{ $new_product->id }}/{{ $new_product->image1 ?? 'not-found.jpg' }}"
                                        ...
                                        <div class="size-child product-hover-show">
                                            <a href="{{ route('products.show', $new_product->id) }}"
                                               class="w-100 h-100 d-inline-block">
                                                <div
                                                    class="float-left form-control bg-dark text-white text-left border-0 d-inline-block w-auto position-relative py-1 height-30">
                                                    <input type="checkbox" id="new-{{ $new_product->id }}"
                                                           class="compare-checkbox" product-id="{{ $new_product->id }}">
                                                    <label for="new-{{ $new_product->id }}">Compare</label>
                                                </div>
                                            </a>
                                        </div>
                                        <div
                                            class="bg-white product-hover-show2 position-absolute height-30 w-100 line-height-30 bottom-0">
                                            <ul class="list-inline">
                                                <li>
                                                    <i class="fa fa-registered"></i> {{ $new_product->car->manufacturing_year ?? ''}}
                                                </li>
                                                <li>
                                                    <i class="fa fa-cog"></i> {{ $new_product->car->steering_gear_type ?? ''}}
                                                </li>
                                                <li><i class="fa fa-dashboard"></i> {{ $new_product->car->milage ?? ''}}
                                                    mi
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="text-dark clearfix px-3 py-1">
                                        ...
                                        <div class="display-6 my-0 owl-heading"><a
                                                href="{{ route('products.show', $new_product->id) }}"
                                                class="">{{ $new_product->name }}</a></div>
                                        <div class="separator"></div>
                    ...
                    <a href="{{ route('cars.index') }}?conditions=new" class="button red mt-3">View All<i
    ...
    <section class="tg-haslayout tg-vehicle-compare">
        <div id="tg-compare-slider"
             class="tg-compare-slider tg-comparebox swiper-container-horizontal swiper-container-fade">
            <div class="swiper-wrapper" style="transition-duration: 0ms;">
                @foreach($versus_sliders as $slider)
                    <div class="swiper-slide swiper-slide-prev"
                         style="width: 1149px; opacity: 1; transform: translate3d(0px, 0px, 0px); transition-duration: 0ms;">
                        <div class="tg-compare tg-compare-left">
                            <figure class="tg-leftimginout">
                                <img src="{{ url('assets/versus-sliders') }}/{{ $slider->product1_image }}"
                                     alt="{{ $slider->product1->name }}">
                            </figure>
                            <div class="tg-carfeatures">
                                <span
                                    class="tg-icon icon-krop-big-logo">{{ $slider->product1->brand->name ?? ''}}</span>
                        ...
                        <div class="tg-compare tg-compare-right">
                            ...
                            <figure class="tg-rightimginout">
                                <img src="{{ url('assets/versus-sliders') }}/{{ $slider->product2_image }}"
                                     alt="{{ $slider->product2->brand->name ?? ''}}">
                            </figure>
                        </div>
                        <div class="tg-vstag d-none cursor-pointer"
                             onclick="location.href=document.getElementById('vs-slider-button')">
                            <div class="holder">
                                <div class="tg-border-heading">
                                    <h3>vs</h3>
                                </div>
                                <a id="vs-slider-button"
                                   href="{{ route('compare') }}/{{ $slider->product1->brand->name.'-'.$slider->product1->model->name.'-'.$slider->product1->package->name.'-and-'.$slider->product2->brand->name.'-'.$slider->product2->model->name.'-'.$slider->product2->package->name }}">view
                                    now</a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                                ...
                                <div class="bg-white shadow-sm mx-2 mb-3 zoom-parent overflow-hidden shadow-hover-10">
                                    <div class="size-53 clearfix">
                                        <div class="size-child zoom-target-1">
                                            <img class="position-center w-100"
                                                 src="{{ url('/') }}/assets/products/{{ $used_product->id }}/{{ $used_product->image1 ?? 'not-found.jpg' }}"
                                                 alt="{{ $used_product->name }}">
                                        </div>
                                        <div
                                            class="float-left form-control bg-dark text-white text-left border-0 d-inline-block w-auto position-relative height-30 py-1">
                                            <input type="checkbox" id="used-{{ $used_product->id }}"
                                                   class="compare-checkbox" product-id="{{ $used_product->id }}">
                                    ...
                                    <div class="text-dark clearfix px-3 py-1">
                                        ...
                                        <div class="display-6 my-0 owl-heading"><a
                                                href="{{ route('products.show', $used_product->id) }}"
                                                class="">{{ $used_product->name }}</a></div>
                                        <div class="separator"></div>
                                        <div class="text-center font-16">BDT {{ $used_product->msrp }}</div>
                                        <div class="row text-left">
                                            <div class="col-6 my-1">
                                                <i class="fa fa-road"></i> {{ $used_product->kms_driven ?? ''}} km
                                                driven
                                            </div>
                                            <div class="col-6 my-1">
                                                <i class="fa fa-calendar"></i> {{ $used_product->car->milage ?? ''}} km
                                                milage
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <a href="{{ route('cars.index') }}?conditions=used" class="button red mt-3">View All<i
                            class="fa fa-chevron-circle-right" aria-hidden="true"></i></a>
                </div>
            </div>
        </div>
    ...
    <section class="sms-banner">
        <div class="container">
            <div class="owl-carousel owl-theme" data-nav-arrow="true" data-items="2" data-md-items="2" data-sm-items="2"
                 data-xs-items="1" data-space="20">
                @foreach($advertisements as $advertisement)
                    <div class="item">
                        <div class="wpb_single_image">
                            <a href="{{ $advertisement->url }}"><img
                                    src="{{ asset('assets/advertisements') }}/{{ $advertisement->image }}"></a>
                        </div>
                    </div>
                @endforeach
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <a href="{{ route('popular-products') }}?categories=car" class="button red mt-3">View All<i
                            class="fa fa-chevron-circle-right" aria-hidden="true"></i></a>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-sm-12 text-center">
                    ...
                    <a href="{{ route('cars.index') }}?conditions=reconditioned" class="button red mt-3">View All<i
                            class="fa fa-chevron-circle-right" aria-hidden="true"></i></a>
                </div>
            </div>
        </div>
    ...
    <section id="partner">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="owl-carousel owl-loaded owl-drag" data-nav-dots="true" data-items="5" data-md-items="5"
                         data-sm-items="3" data-xs-items="2" data-space="10">
                        <div class="owl-stage-outer">
                            <div class="owl-stage"
                                 style="transform: translate3d(-2530px, 0px, 0px); transition: all 0.25s ease 0s; width: 4140px;">
                                @foreach($suppliers as $supplier)
                                    <div class="owl-item cloned" style="width: 220px; margin-right: 10px;">
                                        <div class="item">
                                            <img class="img-fluid center-block"
                                                 src="{{ url('/') }}/assets/profile/{{ $supplier->photo }}" alt="">
                                        </div>
                                    </div>
                                @endforeach
                            </div>
