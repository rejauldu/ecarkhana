    ...
    <div class="row">
        ...
        <div class="col">
            <div class="card opacity-5" v-if="configuration < 2 && products.length < 2">
                <div class="size-53 position-relative">
                    <div class="size-child">
                        <img class="card-img-top img-fluid position-center" src="{{ url('/') }}/images/add-car.jpg" alt="Card image">
                    </div>
                </div>
                <div class="card-body">
            ...
            <div class="card" @click.prevent="openModal(2)" v-else-if="page == 1 && configuration == 2">
                <div class="size-53 position-relative">
                    <div class="size-child">
                        <img class="card-img-top img-fluid  cursor-pointer hover-opacity-5 position-center" src="{{ url('/') }}/images/add-car.jpg" alt="Card image">
                    </div>
                </div>
                <div class="card-body">
                    <div class="input-group rounded-0 rounded-top" @click.prevent="openModal(2)">
