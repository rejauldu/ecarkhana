        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-4">
                ...
                <div class="card" v-else-if="configuration > 1 || products.length > 0">
                    ...
                    <div class="position-center"><i class="fa fa-spinner fa-spin text-dark"></i></div>
                </div>
            </div>
            <!-- Side bar start -->
            <div class="col-12 col-sm-6 col-md-4">
            ...
            <div class="col-12 col-sm-6 col-md-4">
                ...
                <div class="card" v-else-if="configuration > 3 || products.length > 2">
                    ...
                    <div class="card-body">
                        ...
                        <div><span>@{{ products[1].brand.name }} @{{ products[1].model.name }} @{{ products[1].manufacturing_year }}, @{{ products[1].package.name }}</span> <i class="fa fa-pencil cursor-pointer btn-light text-danger" @click.prevent="page=1; configuration = 3; removeProduct(2)"></i></div>
                        <div class="display-6 text-dark">Tk. @{{ products[1].msrp }}</div>
                    </div>
                </div>
            </div>
            ...
            getProduct: function() {
                ...
                $.ajax({
                    ...
                    success: function(result){
                        _this.page = 1;
                        _this.configuration = _this.products.length+2;
                        if(_this.isReplace) {
                            _this.products[_this.index] = result;
